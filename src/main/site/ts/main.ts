...
const rising = document.querySelector('#moon') as HTMLInputElement
const moon = document.querySelector('#rising') as HTMLInputElement
...
document.addEventListener("keyup", async function test () { await updateValues("Gemini", "Gemini", "Gemini") })
postAndUpdate();
