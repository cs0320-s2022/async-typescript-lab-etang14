...
const rising = document.querySelector('#moon');
const moon = document.querySelector('#rising');
...
document.addEventListener("keyup", function test() {
    return __awaiter(this, void 0, void 0, function* () { yield updateValues("Gemini", "Gemini", "Gemini"); });
});
postAndUpdate();
